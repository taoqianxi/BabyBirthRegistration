  ...
  ,admin = {
    ...
    ,sendAuthCode: function(options){
      ...
      $body.on('click', options.elem, function(){
        ...
        var verCode=options.elemVercode.val();
        if(mAction!=="register"){
          if(verCode===undefined||verCode.length<4){
        ...
        var keyHex=CryptoJS.enc.Utf8.parse(setter.tripeDesKey);
        var encryptObject=CryptoJS.TripleDES.encrypt(value, keyHex, {
          mode: CryptoJS.mode.ECB,
          padding: CryptoJS.pad.Pkcs7});
        value=encryptObject.toString();
        ...
        admin.req($.extend(true, {
          ...
          ,type: 'get'
          ,data: {
            phone:value,"action":Base64.encode64(mAction),"verCode":Base64.encode64(verCode)
          }
    ...
    ,theme: function(options){
      ...
      ,styleText = laytpl([
        ...
        //logo  '.layui-layout-admin .layui-logo{background-color:{{d.color.logo || d.color.main}} !important;}'
        ,'.layui-layout-admin .layui-logo{background-color:{{d.color.main}} !important;}'
