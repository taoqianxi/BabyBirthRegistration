...
layui.define(['laytpl', 'layer'], function (exports) {
    ...
    view.req = function (options) {
        ...
        var that = this, success = options.success, error = options.error, request = setter.request,response = setter.response, debug = function () {
            return setter.debug ? '<br><cite>URL锛�</cite>' + options.url : '';
        };
    ...
    view.popup = function (options) {
        ...
        delete options.success;
        delete options.skin;
        return parent.layer.open($.extend({
            type: 1
            , title: '<p style="color: white">鎻愮ず</p>'
            , content: ''
