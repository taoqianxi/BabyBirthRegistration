layui.define(['laytpl', 'layer', 'element', 'util'], function(exports){
  exports('setter', {
    ...
    ,engine: '.html'
    ,pageTabs: false
    ,baseUrl:'http://localhost:8080/BabyBirthRegistration'
    ,requestFlag:'BabyBirthRegistration'
    ,version:'1'
    ,clientVersion:'1.0.0'//版本
    ,name: 'BabyBirthRegistration'
    ,tableName: 'politicsAdmin'
    ,MOD_NAME: 'admin'
    ,debug: false
    ,interceptor: true
    ,versionUpdateLog:"1.小婉政治管理平台版本发布"
    ,request: {tokenName: 'token' ,timeStamp:'timeStamp',userName:'name',userIcon:'icon'}
    ,response: {statusName: 'responseCode',statusCode: {ok: '0',token_error:'-2',logout: '1001'},msgName: 'errMessage',dataName: 'data'}
    ,indPage: ['/user/login' ,'/user/reg','/user/forget' ,'/user/appeal']
    ,extend: [ 'echarts', 'echartsTheme','iconPicker']
    ,theme: {
      color: [
