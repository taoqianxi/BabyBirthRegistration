layui.define('table',function (exports) {
    ...
    Class.prototype.createHTMLDocument = function () {
        var that = this
            ...
            ,index= that.index;
        //创建页面元素
        var html = '<div class="layui-container" style="width: 1000px;padding: 0px;">\
                    <div class="layui-row">\
                      <div class="'+MD5+'">\
                        <table class="layui-hide" id="'+LEFT_TABLE+index+'" lay-filter="'+FILTER+'"></table>\
                      </div>\
                      <div class="'+MD2+'" style="text-align: center;">\
                        <div id="'+LEFT_BTN+index+'"  style="margin-bottom: 10px;"><button data-type="0" data-index="'+index+'" class="layui-btn layui-btn-normal '+DISABLED+' '+BTN_STLY+'"> <i class="layui-icon">&#xe602;</i></button></div>\
                        <div id="'+RIGHT_BTN+index+'" ><button data-type="1" data-index="'+index+'" class="layui-btn layui-btn-normal '+DISABLED+' '+BTN_STLY+'"> <i class="layui-icon">&#xe603;</i></button></div>\
                      </div>\
                      <div class="'+MD5+'">\
    ...
    $(document).on('click', '.' + BTN_STLY, function () {
        var flag = true;
        if (transfer.options.moveBefore) {
            flag = transfer.options.moveBefore()
        }
        if (flag) {
