...
layui.define(['laytpl', 'laypage', 'layer', 'form'], function(exports){
    ...
    Class.prototype.pullData = function(curr, loadIndex){
        ...
        if(options.url){ //Ajax请求
            ...
            if (options.isPage) {
                var pagination = {};
                if (curr) { pagination.pageNum = curr }
                if (options.limit) {pagination.pageSize = options.limit}
           ...
           // params._openx_head = layui.data("layuiAdmin") ? {}:layui.data("layuiAdmin")._openx_head;

            var tokenName = layui.setter.request.tokenName;
            if (tokenName) {
                var tableName = layui.setter.tableName
                params._openx_head = layui.data(tableName)._openx_head || {};
            }
