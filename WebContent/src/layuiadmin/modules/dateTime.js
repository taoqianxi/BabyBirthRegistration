layui.define(function (exports) {
    ...
    function getWeekSaturday() {
        var weekSaturday = new Date(nowYear, nowMonth, nowDay - nowDayOfWeek + 6);
        return formatDate(weekSaturday);
    }
    ...
    //下周五
    function nextFriday() {
        var nextFriday = new Date(nowYear, nowMonth, nowDay - nowDayOfWeek + 12);
        return formatDate(nextFriday);
    }

    //上周六
    function getLastSaturday() {
        var num = new Date(nowYear, nowMonth, nowDay - nowDayOfWeek - 2);
        return formatDate(num);
    }

    //本周五
    function getThisWeekFriday() {
        var num = new Date(nowYear, nowMonth, nowDay - nowDayOfWeek + 5);
        return formatDate(num);
    }

    function getDate(day) {
        var num = new Date(nowYear, nowMonth, nowDay - day);
        return formatDate(num);
    }
    ...
    exports('dateTime', {
        ...
        getWeekSaturday: getWeekSaturday,
        nextFriday: nextFriday,
        getLastSaturday: getLastSaturday,
        getThisWeekFriday: getThisWeekFriday,
        getDate: getDate
    })
});